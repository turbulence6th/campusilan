...
class AdvertTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @advert = Advert.new(:name => 'Satılık Buzdolabı..-_*+""', :price => 1200, :explication => 'Kullanılmamış Buz dolabı satıyorum',:user => @user, :advertable => @advertable, :active => true, :urgent => false, :opportunity => false, :ours => false)
